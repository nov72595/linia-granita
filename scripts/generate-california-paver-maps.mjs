...
const targetDir = path.resolve(__dirname, "..", "public", "tiles", "pavers", "30x30-california");
...
console.log("Generated california maps:", { heightPath, roughnessPath, aoPath, normalPath });
