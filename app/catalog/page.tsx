                ...
                className={`group relative flex min-h-[232px] flex-col overflow-hidden rounded-[28px] border border-white/10 bg-white/[0.03] p-5 min-[420px]:min-h-[248px] min-[420px]:p-6 backdrop-blur-2xl transition-all duration-300 hover:-translate-y-1 hover:border-white/20 hover:bg-white/[0.06] ${
                  key === "single"
                    ...
                    : key === "double"
                      ...
                      : key === "combo"
                        ? "pr-[124px] min-[420px]:pr-[136px] md:pr-[188px]"
                        : key === "complex"
              ...
              >
                <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-[#111] px-3 py-1">
                  ...
                  <span className="text-[10px] uppercase tracking-[0.16em] text-[#b0b0b0]">
                    {key === "combo" ? "Портфолио студии" : "Тип памятника"}
                  </span>
                </div>
                ...
                {key !== "combo" ? (
                  <p className="mt-2 text-xs uppercase tracking-[0.18em] text-[#8f8f8f]">{counts[key]} макетов</p>
                ) : null}
                ...
                {key === "single" && (
                  <div className="pointer-events-none absolute right-2 top-4 bottom-4 block w-[132px] min-[420px]:w-[148px] md:right-1 md:w-[186px]">
                ...
                {key === "double" && (
                  <div className="pointer-events-none absolute right-1 top-4 bottom-4 block w-[120px] min-[420px]:w-[134px] md:right-0 md:w-[204px]">
                ...
                {key === "combo" && (
                  <div className="pointer-events-none absolute right-2 top-4 bottom-4 block w-[108px] min-[420px]:w-[124px] md:right-1 md:w-[178px]">
                    <Image
                ...
                {key === "complex" && (
                  <div className="pointer-events-none absolute right-2 top-4 bottom-4 block w-[130px] min-[420px]:w-[146px] md:right-1 md:w-[178px]">
                    <Image
                      src="/monuments/combo-reference-cutout.png"
                      alt={item.title}
                      fill
